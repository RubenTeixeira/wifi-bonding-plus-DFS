...
sed -i '/gChannelBondingMode24GHz=/d;/g11dSupportEnabled=/d;/gChannelBondingMode5GHz=/d;/gForce1x1Exception=/d;/sae_enabled=/d;/BandCapability=/d;/gSkipDfsChannelInP2pSearch=/d;/isP2pDeviceAddrAdministrated=/d;s/^END$/gChannelBondingMode24GHz=1\ngChannelBondingMode5GHz=1\ngForce1x1Exception=0\nsae_enabled=1\nBandCapability=0\nWmmIsEnabled=1\ngEnableDFSChnlScan=1\ngAllowDFSChannelRoam=2\ng11hSupportEnabled=1\ngEnableDFSMasterCap=1\ngInitialScanNoDFSChnl=0\ng11dSupportEnabled=0\ngEnableBypass11d=1\ngSkipDfsChannelInP2pSearch=0\nisP2pDeviceAddrAdministrated=0\nEND/g' $MODPATH$CFG
}
done
